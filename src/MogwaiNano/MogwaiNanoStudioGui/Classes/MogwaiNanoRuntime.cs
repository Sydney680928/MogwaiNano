...
namespace MogwaiNanoStudioGui.Classes
{
    public class MogwaiNanoRuntime
    {
        ...
        public delegate void NanoConsoleClearHandler();
        public event NanoConsoleClearHandler? NanoConsoleClear;

        public delegate void NanoDebugClearHandler();
        public event NanoDebugClearHandler? NanoDebugClear;
        ...
        private void NanoClient_MessageReceived(object? sender, ServerMessage message)
        {
            ...
            else if (message.Function == "CONSOLE.CLEAR")
            {
                NanoConsoleClear?.Invoke();
            }
            else if (message.Function == "DEBUG.CLEAR")
            {
                NanoDebugClear?.Invoke();
            }   
            else
            {
